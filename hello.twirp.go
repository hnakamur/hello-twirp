...
/*
Package hellotwirp is a generated twirp stub package.
...
func NewHelloWorldProtobufClient(addr string, client *http.Client) HelloWorld {
...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloReq) (*HelloResp, error) {
	url := c.urlBase + HelloWorldPathPrefix + "Hello"
	out := new(HelloResp)
...
func NewHelloWorldJSONClient(addr string, client *http.Client) HelloWorld {
...
const HelloWorldPathPrefix = "/twirp/com.github.hnakamur.hello_twirp.HelloWorld/"

func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "com.github.hnakamur.hello_twirp")
	...
	switch req.URL.Path {
	case "/twirp/com.github.hnakamur.hello_twirp.HelloWorld/Hello":
